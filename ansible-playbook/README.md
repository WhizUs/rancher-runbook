# Rancher Node Installation - Provisioning

After the infrastructure was created by terraform, the virtual machines are provisioned by this playbook to setup the whole rancher node
...
After successful setup your playbook, you just need to run following command to start the deployment
     ...
     ansible-playbook ./rancher-provisioning.yml -i ../inventory
